...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=localhost\\SQLEXPRESS;Database=Proyecto_POO_DB;Trusted_Connection=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Appointment>(entity =>
            {
                ...
                entity.HasOne(d => d.DuiNavigation)
                    ...
                    .HasConstraintName("FK__APPOINTMENT__Dui__5535A963");

                entity.HasOne(d => d.IdCabinNavigation)
                    .WithMany(p => p.Appointments)
                    .HasForeignKey(d => d.IdCabin)
                    .HasConstraintName("FK__APPOINTME__id_ca__5441852A");
            });
            ...
            modelBuilder.Entity<CabinxCitizen>(entity =>
            {
                entity.HasKey(e => new { e.Dui, e.IdCabin })
                    .HasName("PK__CABINxCI__55F00C04E7032301");
                ...
                entity.HasOne(d => d.DuiNavigation)
                    ...
                    .HasConstraintName("FK__CABINxCITIZ__Dui__571DF1D5");

                entity.HasOne(d => d.IdCabinNavigation)
                    .WithMany(p => p.CabinxCitizens)
                    .HasForeignKey(d => d.IdCabin)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__CABINxCIT__Id_Ca__5812160E");
            });
            ...
            modelBuilder.Entity<Citizen>(entity =>
            {
                entity.HasKey(e => e.Dui)
                    .HasName("PK__CITIZEN__C0317D9099B0B903");
                ...
                entity.HasOne(d => d.IdDiseaseNavigation)
                    ...
                    .HasConstraintName("FK__CITIZEN__Id_Dise__6FE99F9F");
